 ...
 */
static void send_sensor_topology(int lp,Element_topology* elem_top,int element_id){
	void* message;
	size_t message_size;
 ...
 */
static void send_actuator_topology(int lp,Element_topology* elem_top, int element_id){
	void* message;
	size_t message_size;
 ...
 */
static void send_below_devices_info(int lp,general_topology* gen_top,Element_topology* elem_top,below_devs below_devices,int element_id, setup_data_types parent_struct){
	void* message;
	size_t message_size;
 ...
 */
static void send_lan_topology(int lp,general_topology* gen_top,Element_topology* elem_top,int element_id){
	void* message;
	size_t message_size;
	...
	*/
	...
	send_below_devices_info(lp,gen_top,elem_top,devs,element_id,SETUP_DATA_LAN_TOPOLOGY);
}
 ...
 */
static void send_wan_topology(int lp,general_topology* gen_top, Element_topology* elem_top,int element_id){
	void* message;
	size_t message_size;
 ...
 */
static void send_node_topology(int lp,general_topology* gen_top, Element_topology* elem_top,int element_id){
	void* message;
	size_t message_size;
...
static void send_element_topology(int lp,total_topology* tot_top,int element_id){
	...
	int num_act_paths=GET_NUM_ACT_PATHS(elem_top);
	void* message;
	size_t message_size;
	...
	switch(GET_TYPE(elem_top)){
		case SENSOR:
			send_sensor_topology(lp,elem_top,element_id);
			break;
		case ACTUATOR:
			send_actuator_topology(lp,elem_top,element_id);
			break;
		case LAN:
			send_lan_topology(lp,gen_top,elem_top,element_id);
			break;
		case WAN:
			send_wan_topology(lp,gen_top,elem_top,element_id);
			break;
		case NODE:
			send_node_topology(lp,gen_top,elem_top,element_id);
			break;
		default:
